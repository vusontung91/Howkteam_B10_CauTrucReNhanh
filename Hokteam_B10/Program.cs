...
namespace Hokteam_B10
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            #region Viết chương trình tính năm âm lịch từ năm dương lịch
            //Năm âm lịch = Can + Chi
            ...
            string xephang = (diem >= 8 && diem <= 10) ? "Gioi" : (diem < 8 && diem >= 6.5) ? "Kha" : (diem < 6.5 && diem >= 5) ? "Trung Binh" : "Kem";
            Console.WriteLine(xephang);
            Console.ReadLine();
